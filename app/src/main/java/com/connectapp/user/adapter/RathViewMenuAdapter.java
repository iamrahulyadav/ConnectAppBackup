...
public class RathViewMenuAdapter extends BaseAdapter {
	...
	public RathViewMenuAdapter(Context mContext, Activity mActivity) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			hView = mInflater.inflate(R.layout.list_item_menu_rath, null);
