...
public class ChatContactsAdapter extends RecyclerView.Adapter<ChatContactsAdapter.ViewHolder> implements Filterable {
    ...
    public ChatContactsAdapter(Context context, List<Friend> items) {
    ...
    @Override
    public ChatContactsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
