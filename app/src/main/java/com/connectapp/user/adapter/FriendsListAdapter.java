...
import com.connectapp.user.custom.CircleTransform;
...
public class FriendsListAdapter extends RecyclerView.Adapter<FriendsListAdapter.ViewHolder> {
    ...
    private ArrayList<ChatContact> students = new ArrayList<>();

    private Context ctx;


    // Provide a suitable constructor (depends on the kind of dataset)
    public FriendsListAdapter(Context context, ArrayList<ChatContact> items) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, ChatContact obj, int position);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final ChatContact c = students.get(position);
