...
public class DemoDistListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        populateCountryList();
        CommentsListArrayAdapter adapter = new CommentsListArrayAdapter(DemoDistListActivity.this,
                countryList);
        ...
        listView_country.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                returnIntent.putExtra(DISTRICT, c.getName());
    ...
    private void populateCountryList() {
        ...
        countrynames = getResources().getStringArray(R.array.district_array_demo);
        countrycodes = getResources().getStringArray(R.array.district_code_array_demo);
