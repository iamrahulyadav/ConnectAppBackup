...
public class DemoTehsilListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        populateCountryList();
        CommentsListArrayAdapter adapter = new CommentsListArrayAdapter(DemoTehsilListActivity.this,
                countryList);
        ...
        listView_country.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                returnIntent.putExtra(TEHSIL, c.getName());
    ...
    private void populateCountryList() {
        ...
        countrynames = getResources().getStringArray(R.array.tehsil_array_demo);
        countrycodes = getResources().getStringArray(R.array.tehsil_code_array_demo);
