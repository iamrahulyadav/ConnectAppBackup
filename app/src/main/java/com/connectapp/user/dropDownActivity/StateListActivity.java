...
public class StateListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        populateCountryList();
        CommentsListArrayAdapter adapter = new CommentsListArrayAdapter(StateListActivity.this,
                countryList);
    ...
    private void populateCountryList() {
        ...
        countrynames = getResources().getStringArray(R.array.states_array);
        countrycodes = getResources().getStringArray(R.array.states_code_array);
