...
public class DemoVillageListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        populateCountryList();
        CommentsListArrayAdapter adapter = new CommentsListArrayAdapter(DemoVillageListActivity.this,
                countryList);
        ...
        listView_country.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                returnIntent.putExtra(VILLAGE, c.getName());
    ...
    private void populateCountryList() {
        ...
        countrynames = getResources().getStringArray(R.array.village_array_demo);
        countrycodes = getResources().getStringArray(R.array.village_code_array_demo);
